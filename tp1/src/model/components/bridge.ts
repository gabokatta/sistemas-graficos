...
let ropeSweep: Sweepable;

export class Bridge {

    private static buildTensor(length: number, radius: number = 0.1): Revolution {
...
function saveRopeSweep(sweep: Sweepable) {
    ropeSweep = sweep;
}

function getPathPosition(position: number, path: Curve): any {
